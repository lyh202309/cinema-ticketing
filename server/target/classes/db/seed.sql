...
(1, '流浪地球3',  '科幻', 142, '郭帆', 8.8, '/img/movie1.png', '2026-07-20', '太阳危机之后，人类启程寻找新家园。', 1),
(2, '千与千寻',   '动画', 125, '宫崎骏', 9.4, '/img/movie2.png', '2026-06-01', '少女误入神灵世界的奇幻冒险。', 1),
(3, '沙丘3',      '科幻', 168, '丹尼斯', 8.1, '/img/movie3.png', '2026-08-15', '厄拉科斯的沙与血，命运之战。', 1),
(4, '热辣滚烫',   '喜剧', 120, '贾玲', 8.0, '/img/movie4.png', '2026-07-10', '人生的拳台，为自己赢一次。', 1);

-- 即将上映（status=0，供首页"即将上映"区块）
INSERT INTO tb_movie (id, title, genre, duration, director, rating, poster, release_date, description, status) VALUES
(5, '封神第二部', '神话', 180, '乌尔善', 0.0, '/img/movie5.png', '2026-10-01', '昆仑山下的仙魔之战，姜子牙率众神共赴大劫。', 0),
(6, '碟中谍8：最终清算', '动作', 150, '克里斯托弗·麦奎里', 0.0, '/img/movie6.png', '2026-12-18', '伊森·亨特的终极任务，生死一线。', 0);
...
INSERT INTO tb_session (id, movie_id, cinema_id, hall_id, start_time, end_time, price, is_hot, sale_start_time, sale_end_time, status) VALUES
                                                                                                                                           ...
                                                                                                                                           (7, 1, 3, 5, NOW() + INTERVAL 2 DAY + INTERVAL 8 HOUR, NOW() + INTERVAL 2 DAY + INTERVAL 8 HOUR + INTERVAL 152 MINUTE, 58.00, 1,
